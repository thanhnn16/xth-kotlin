...
import androidx.compose.ui.Modifier // Sửa ở đây
...
fun Restaurant () {
    Column {
        ...
        Box(
            ...
            Card {
                Image(painter = painterResource(id = R.drawable.imgfood), contentDescription = null,
                    modifier = Modifier
                        .width(312.dp)
                        .height(185.dp)
                        .clip(
        ...
        Box(
            ...
            Column {
                Row {
                    ...
                    Text(text = "Rating: 4.5", fontSize = 16.sp, modifier = Modifier.padding(start = 8.dp, end = 150.dp) )
                    Text(text = "320", fontSize = 16.sp, modifier = Modifier.padding(start = 8.dp) )
                }
                Spacer(modifier = Modifier.height(10.dp))
                Row {
                    Image(painter = painterResource(id = R.drawable.banhsinhnhat), contentDescription =null,
                        modifier = Modifier
                            .size(24.dp)
                    )
                    Text(text = "Dishes: 3.8", fontSize = 16.sp, modifier = Modifier.padding(start = 8.dp, end = 150.dp) )
                    Text(text = "48", fontSize = 16.sp, modifier = Modifier.padding(start = 8.dp) )
                }
                Spacer(modifier = Modifier.height(10.dp))
                Row {
                    Image(painter = painterResource(id = R.drawable.document), contentDescription =null,
                        modifier = Modifier
                            .size(24.dp)
                    )
                    Text(text = "Your Order", fontSize = 16.sp, modifier = Modifier.padding(start = 8.dp, end = 155.dp) )
        ...
        Box(
            ...
            Column {
                Row{
                    Text(text = "Your Feature Items", fontSize = 20.sp, modifier = Modifier.padding(start = 8.dp, end = 150.dp) )
                    Text(text = "See All", fontSize = 14.sp, modifier = Modifier.padding(start = 7.dp, end = 4.dp), color = Color.Green )
                }
                LazyRow {
